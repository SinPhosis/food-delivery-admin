  ...
  return (
    <div className="w-52 h-[1024px] px-5 py-9 bg-white inline-flex flex-col justify-start items-start gap-10 overflow-hidden">
      ...
      <div className="self-stretch inline-flex flex-col justify-start items-center gap-6">
        <div className="self-stretch h-10 px-6 py-2 inline-flex justify-start items-center gap-2.5">
          <div className="w-5 h-5 relative overflow-hidden">
            <img
              className="w-4 h-4 left-[2.75px] top-[2.75px] absolute "
              src="../Dashboard_Icon_Black.svg"
            />
          </div>
          <div className="justify-start text-black text-sm font-normal font-['Inter'] leading-tight cursor-pointer" onClick={() => router.back()}>
            Food menu
          </div>
        </div>
      </div>
      <div className="self-stretch h-10 px-6 rounded-full bg-[#18181b] inline-flex justify-start items-center gap-2.5">
        <div className="w-5 h-5 relative overflow-hidden">
          <img
            className="w-5 h-3.5 left-[1.83px] top-[4.58px] absolute"
            src="../Truck_Icon_White.svg"
          />
        </div>
        <div className="justify-start text-white     text-sm font-medium font-['Inter'] leading-tight" onClick={() => router.push("/admin/admin-orders")}>
          Orders
        </div>
      </div>
